...
class MsgMain extends StatelessWidget { // Change to ChatPage() - Must be StatelessWidget that returns a Scaffold - move to page folder
  ...
  Widget build (BuildContext context) {
    ...
    Widget buildItem(BuildContext context, DocumentSnapshot document) { // buildMessageThread() 
